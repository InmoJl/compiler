...
const arrToGenerator = require('../common/arrayToGenerator')
const PeekTokenIterator = require('../parser/util/PeekTokenIterator')

describe('SimpleParserTest', () => {

    it('parse_test', () => {

        const source = '1+2+3+4'
        const lexer = new Lexer()
        const tokens = lexer.analyse(arrToGenerator([...source]))
        const tokenIt = new PeekTokenIterator(arrToGenerator(tokens))
